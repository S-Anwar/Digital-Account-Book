...
def main(username):
    ...
    # OliveDrab1
    header2="          Accounts            "
    sec2 = LabelFrame(root, text=header2, labelanchor='n', background="RosyBrown1", font=(18), fg='indian red')
    sec2.pack(fill='both', expand='yes')
    canvas2 = Canvas(sec2)
    canvas2.pack(side='left', expand='yes', fill='both')
    yscroll = Scrollbar(sec2, orient='vertical', command=canvas2.yview)
    ...
    def show():
        ...
        res = cur.fetchall()
        i=1
        Label(myframe, text="Title", font=(18), width='20', fg='seashell4', height='2').grid(row=0, column=0)
        Label(myframe, text="Email", font=(18), width='20', fg='seashell4', height='2').grid(row=0, column=1)
        Label(myframe, text="Password", font=(18), width='20', fg='seashell4', height='2').grid(row=0, column=2)
        Label(myframe, text="Details", font=(18), width='20', fg='seashell4', height='2').grid(row=0, column=3)
        for row in res:
            Label(myframe, text=str(row[0]), font=(16), width='20', fg='indian red', height='2').grid(row=i, column=0)
            Label(myframe, text=str(row[1]), font=(16), width='20', fg='indian red', height='2').grid(row=i, column=1)
            Label(myframe, text=str(row[2]), font=(16), width='20', fg='indian red', height='2').grid(row=i, column=2)
            Label(myframe, text=str(row[3]), font=(16), width='20', fg='indian red', height='2').grid(row=i, column=3)
            i=i+1
